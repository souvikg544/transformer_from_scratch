...
os.environ['WANDB_DIR'] = '/ssd_scratch/cvit/souvik/'
...
def run_validation(model, validation_ds, tokenizer_src, tokenizer_tgt, max_len, device, print_msg, global_step, writer, num_examples=20):
    model.eval()
    count = 0
